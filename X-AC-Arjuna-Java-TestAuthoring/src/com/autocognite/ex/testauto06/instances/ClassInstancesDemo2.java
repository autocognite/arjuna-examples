...
@TestClass
@Instances( execVars={"var1=a","var2=c,d"})
public class ClassInstancesDemo2{
	...
	public ClassInstancesDemo2(TestVariables testClassVars) throws Exception{		
		...
		assertEquals("Sample Purpose", testClassVars.execVars().string("Var2"), "c");
	}
	...
	public void test1(TestVariables testMethodVars) throws Exception{	
		...
		assertEquals("Sample Purpose", testMethodVars.execVars().string("Var2"), "c");
