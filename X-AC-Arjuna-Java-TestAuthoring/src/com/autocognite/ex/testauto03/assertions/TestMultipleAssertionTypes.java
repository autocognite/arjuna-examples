...
public class TestMultipleAssertionTypes {
	...
	/*
	 * Example Code - Basic Assertion with Message, Expected to fail Notice the
	 * usefulness of the message displayed. Imagine this assertion was used for
	...
	/*
	 * ---------------------------------------------------------- All subsequent
	 * examples demonstrated with Message argument I strongly suggest this
	 * option for meaningful reports
	 * ----------------------------------------------------------
	 */

	/*
	 * Example code for assertEquals and assertNotEquals The method is available
	 * for char, int, long, object, string data types It is also available for
	 * float and double types, but is demonstrated separately because of the
	 * nature of assertion being different. You can use assertNotEquals for
	 ...
	 * One must be able to specify 'delta' i.e. acceptable difference. Here the
	 * change in value of delta changes the behavior of assertion.
	 */
	...
	/*
	 * Example Code - Asserting Sameness You can assert that two different
	 * variables should refer to the SAME object in memory. You can also assert
	 * that this should not be the case using assertNotSame.
	 */
	...
	public void testAssertSameFail() throws Exception {
		// Mimicking a situation where different names point to different
		// objects
		StringBuilder sb1 = new StringBuilder();
	...
	/*
	 * Example Code - Assert Null You can also check an object not being null
	 * using assertNotNull
	 */
	...
	/*
	 * Example Code - Assert Array Equality Available for short, int, byte,
	 * long, string arrays
	 */
	...
	/*
	 * You can explicitly make a test Fail/Err Typically used when you are
	 * dealing with application logic in your test automation and the decision
	 * is too complex to be represented using a basic assertion.
	 */
